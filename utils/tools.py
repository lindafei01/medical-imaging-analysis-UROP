'''
download from https://github.com/Bjarten/early-stopping-pytorch/blob/master/pytorchtools.py
modified by: Zi-Chao
'''
import numpy as np
import torch
...
class Save_Checkpoint(object):
    ...
    def __init__(self, save_func, framework='pytorch', verbose=False, delta=0, path='checkpoint.pt', trace_func=print,
                 mode='min'):
        """
        Args:
